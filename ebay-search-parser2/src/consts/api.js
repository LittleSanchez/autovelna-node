...
// export const API_EANS = 'http://192.168.8.139:3213/eans';
export const API_EANS = 'http://localhost:3213/eans';
...
export const EOLTAS_COMPATIBILITY = (hash) => `https://www.eoltas.lt/en-us/rest/product/compatible-manufacturers/${hash}`